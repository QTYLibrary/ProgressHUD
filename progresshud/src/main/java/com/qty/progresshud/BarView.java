...
class BarView extends View implements Determinate {
    ...
    private void init() {
        ...
        mOuterPaint.setStrokeWidth(Utils.dpToPixel(2, getContext()));
        ...
        mBoundGap = Utils.dpToPixel(5, getContext());
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = Utils.dpToPixel(2, getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthDimension = Utils.dpToPixel(100, getContext());
        int heightDimension = Utils.dpToPixel(20, getContext());
