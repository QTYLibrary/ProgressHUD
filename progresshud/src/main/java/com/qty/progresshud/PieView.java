...
class PieView extends View implements Determinate {
    ...
    private void init(){
        ...
        mWhitePaint.setStrokeWidth(Utils.dpToPixel(0.1f, getContext()));
        mWhitePaint.setColor(Color.WHITE);

        mGreyPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mGreyPaint.setStyle(Paint.Style.STROKE);
        mGreyPaint.setStrokeWidth(Utils.dpToPixel(2, getContext()));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = Utils.dpToPixel(4, getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int dimension = Utils.dpToPixel(40, getContext());
